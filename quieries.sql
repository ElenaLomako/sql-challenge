...
SELECT departments.dept_no, departments.dept_name, employees.emp_no AS manager_id, employees.last_name AS manager_last_name, employees.first_name AS manager_first_name
FROM departments
